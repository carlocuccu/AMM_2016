...
<!DOCTYPE html>
    ...
    <html>
            <head>
                    <title>Modifica Oggetto - La bottega del suono</title>
                    <meta charset="UTF-8">
                ...
                <div id="page">
                    ...
                    <div id="content">
                        <div class="formPosition">
                            ...
                            <form action="oggettiVenditore.html" method="get">
                                ...
                                <input type="text" name="idObj" value="${idObj}" class="hidden">
                                <input type="text" name="act" value="${act}" class="hidden">
